...
| Property              | Description                                                  |
| --------------------- | ------------------------------------------------------------ |
| **Scheduled**         | Визначає, чи налаштовано пристрій вводу/виводу для запланованого зв’язку. Зазвичай це встановлюється за допомогою Device Communications Wizard.<br />**Примітка.** Якщо розклад для пристрою віддаленого введення-виводу не вказано, з’єднання буде встановлено під час запуску та залишатиметься підключеним до завершення. Див. Scheduled Communications |
| **Time**              | Сервер вводу-виводу намагатиметься зв'язатися з пристроєм введення-виводу в цей час, а потім через інтервали, визначені нижче. Цей час є лише маркером для Citect SCADA. Якщо ви запустите свій проект після цього часу, сервер вводу-виводу не чекатиме до наступного дня, щоб почати обмінюватися інформацією. Він працюватиме так, ніби ваш проект був запущений до початку. |
| **Period**            | Час між послідовними спробами спілкування. Період має бути довгим щодо driver's watchtime та [Dial]WatchTime. Якщо необхідно, зменште ці watchtime (часи перегляду) або збільште Period, щоб збільшити час перегляду більш ніж вдвічі. Приклади (на основі синхронізації в час 10:00:00): <br />1) Якщо ви введете 12:00:00 у поле Repeat кожний та розпочнете проект о 9 ранку, сервер введення-виводу спілкуватися з пристроєм вводу-виводу о 10:00, потім кожні 12 годин, тобто о 22:00, потім знову о 10:00 наступного дня тощо. <br />2) Якщо ви введете 12:00:00, і запустите свій проект о 16:00, Сервер вводу/виводу зв’яжеться з сервером введення/виведення о 22:00, потім знову о 10:00 наступного дня тощо. Сервер вводу-виводу буде вважати, що зв’язок було встановлено о 10 ранку, тому він продовжує працювати так, ніби він був – зв’язок кожні 12 годин після 10 ранку <br /> 3) Якщо ви введете 3 дні та почнете свій проект о 9 ранку в середу, сервер вводу-виводу буде спілкуватися з пристроєм вводу-виводу о 10:00, потім кожні 3 дні, тобто о 10:00 наступної суботи, потім о 10:00 наступного вівторка тощо. <br />4) Якщо ви введете 6 грудня у повторі кожного разу та запустите проект протягом листопада, сервер вводу-виводу зв'яжеться з пристроєм вводу-виводу о 10 ранку 6 грудня, а потім знову 6 грудня наступного року тощо. <br />Виберіть On Startup для постійного підключення. Щоб розірвати постійне з’єднання, потрібно викликати функцію IODeviceControl() з типом 8.<br /> |
| **Connect Action**    | Cicode, який виконується після встановлення зв’язку з пристроєм вводу-виводу (і перед обробкою будь-яких запитів на читання або запис). |
| **Disconnect Action** | Cicode, який виконується після припинення зв’язку з пристроєм введення-виводу (і після обробки запитів на читання та запис). |
| **Phone Number**      | Номер телефону, який потрібно набрати, щоб ініціювати контакт із пристроєм вводу/виводу. (тобто для пристроїв віддаленого вводу/виводу) |
