...
## 16.1. Життєвий цикл SCADA/HMI в системі АСКТП

Як зазначалося, засоби SCADA/HMI є складовою системи керування технологічними процесами або диспетчерського керування. У свою чергу, технологічний комплекс включає також і сам об’єкт, а отже життєвий цикл АСКТП, як і SCADA/HMI, які є його частиною, прямо залежить (або є складовою) від життєвого циклу об’єкта керування. Таким чином, під час розроблення SCADA/HMI є принаймні чотири ситуації, які можуть відбуватися:
...
У кожній з цих ситуацій можливі різні варіанти життєвих циклів об’єкта керування та підсистем керування, але у будь-якому випадку вони пов’язані між собою. У більшості випадків життєві цикли системи керування та SCADA/HMI не розділяються. Часто розроблення, впровадження та експлуатація розглядаються в контексті життєвого циклу всього автоматизованого комплексу. З іншого боку, відповідно до стандартів ISA-101 та ISA-18.2 розглядаються окремі життєві цикли для HMI та системи тривожної сигналізації. Зрештою, кількість життєвих циклів може визначатися кількістю організацій та людей, які задіяні в процесах керування ними, та тим, як вони відносяться до цільових систем. Для кращого розуміння керування життєвими циклами варто ознайомитися зі стандартами та іншими роботами по системній інженерії.  

Надалі розглядається ситуація, при якій розроблення SCADA/HMI проводиться окремою організацією або особою, яка розглядає цей підрівень керування як окрему систему (проект) зі своїм життєвим циклом. Однак слід розуміти, що про таке розділення можна говорити тільки відносно прикладного програмного забезпечення системи, оскільки інші види забезпечень (технічне, інформаційне, організаційне) стосується усієї системи керування. Тому тут зосереджуємося саме на процесах життєвого циклу ПЗ SCADA/HMI, а інші процеси розглядаються в дисципліні "Проектування АСКТП". 

Вибір моделі, процесів та методів керування життєвим циклом ПЗ визначається рядом факторів. Є спеціалізовані стандарти, які означують життєві цикли стосовно HMI (ISA-101) та систем тривожної сигналізації (ISA-18.2). У загальному, будемо вважати, що життєвий цикл прикладного ПЗ SCADA/HMI поділяється на стадії:

1. **Розроблення технічних вимог (технічного завдання)**. На цій стадії формулюють призначення підсистеми SCADA/HMI і означують основні вимоги до неї. Стадія може завершуватися формуванням документа "Технічні вимоги" або розділом чи окремим документом "Технічне завдання" (ТЗ), яке фіксує принципові вимоги та основні проектні рішення.   

2. **Проектування**. На цій стадії проводяться проектні роботи щодо розроблювальної (модернізованої) SCADA/HMI або її частини. Ця стадія не передбачає створення ПЗ SCADA/HMI, а лише документів щодо проектних рішень. Однак, якщо розглядати саме розроблення прикладного програмного забезпечення, виходом цієї стадії для SCADA/HMI можуть бути вимоги до її ПЗ. 

3. **Реалізація**. Ця стадія передбачає створення програмних проектів для SCADA/HMI та попередні тестування. 

4. **Введення в дію**. Ця стадія передбачає пусконалагоджувальні роботи на об’єкті та навчання персоналу. 

5. **Експлуатація**. На стадії експлуатації проводиться обслуговування SCADA/HMI, що передбачає внесення певних змін у систему за необхідності. 

Цей поділ на стадії умовний, оскільки може відрізнятися від стандартів і прийнятих методологій розроблення.   

## 16.2. Розроблення технічних вимог або технічного завдання
...
## 16.3. Характеристика об’єкта автоматизації та вимоги до системи в цілому
...
**Вимоги до системи в цілому** можуть бути частиною системних стандартів та стадії проектування SCADA/HMI. Зокрема, наприклад, у вимогах до структури та функціонування вказуються структура системи SCADA/HMI, кількість АРМ оператора (робочих станцій), їх розміщення та умови роботи (проектування консолі). 
...
Наприклад, простим варіантом таких вимог може бути перелік ролей, наведений у табл. 16.1. У складнішому випадку для кожної з ролей детально наводиться опис та вказуються усі перераховані вище вимоги. 

*Таблиця 16.1.* Приклад вимог до користувачів
...
У **вимогах до надійності** вказується необхідність резервування частин SCADA/HMI: серверів, шляхів доступу до джерел даних (наприклад ПЛК), мережних компонентів тощо.
...
Детальніше про кібербезпеку читайте в [посібнику](https://pupenasan.github.io/hmibook/9_5.html).

## 16.4. Вимоги до функцій і задач

Вимоги до функцій і задач можна поділити за функціональними підсистеми SCADA/HMI. Для початку варто перерахувати необхідні групи функцій (функціональні підсистеми) для кожної SCADA/HMI. Більшість із них є типовими, а деякі залежать від застосунку. Отже, до необхідних груп функцій SCADA/HMI можуть входити:  
...
У табл.16.2 наведено аналогові змінні та вимоги до них:
...
Таблиця 16.2. Перелік аналогових (числових) змінних, що доступні в ПЛК зі SCADA/HMI
...
У табл. 16.3 наведено дискретні змінні, та вимоги до них. 

*Таблиця 16.3*. Перелік дискретних (типу так/ні) змінних, що доступні в ПЛК зі SCADA/HMI
...
## 16.6. Вимоги до відображення та супервізорного керування (людино-машинного інтерфейсу)

Процеси на стадіях та етапах життєвого циклу для підсистеми HMI досить детально розглянуто в [посібнику](https://pupenasan.github.io/hmibook/10_2.html). Зокрема, згідно зі стандартом ISA-101, розроблення вимог належить до стадії "Системні стандарти" та етапу "Вимоги" стадії "Проектування". Тут зупинимося на переліку найбільш типових вимог:
...
Далі наведено приклад спрощених вимог до підсистеми HMI. 
...
Повинні бути розроблені дисплейні мнемосхеми, наведені в табл.16.4. Інші дисплеї розроблюються за необхідності і попередньо узгоджуються на етапі реалізації. 

*Таблиця 16.4. Перелік обов’язкових дисплеїв* 
...
- колір фону сторінок повинен бути одним із відтінків сірого, на фоні якого добре контрастують світло-сірі та темно-сірі відтінки; рекомендований колір зазначено у табл.16.5; 

*Таблиця 16.5. Призначення кольорів*

![](media16/t10_5.png)

- в анімаційних налаштуваннях необхідно використовувати кольори, які подано в табл.16.5, зміну чи добавлення нових кольорів у палітру слід попередньо узгодити;
...
- межі технологічного устатковання повинні відображатися темно-сірим кольором (див. табл. 16.5); 
...
Після раціоналізації та класифікації тривог, які можуть проводитися за участю розробника SCADA/HMI, формується також перелік тривог. Нижче наведено приклад спрощених вимог до тривог та подій. 
...
У системі слід передбачити принаймні ті пріоритети тривог, що вказані в табл. 16.6.

*Таблиця 16.6. Перелік обов’язкових пріоритетів*
...
Для усіх тривог визначені класи, які наведені в табл. 16.7. У дужках колонки назви класу вказується символ позначення класу. 

Усі тривоги оповіщаються операторові процесу, інші адресати вказані в примітці в табл. 16.7. 

Тривоги слід групувати за ознакою устатковання, або групи устатковання (зони процесу), за якими їх можна фільтрувати в дисплеях тривог. У табл. 16.8 наведено обов’язкові групи тривог.  

*Таблиця 16.7. Перелік обов’язкових класів тривог*
...
*Таблиця 16.8. Перелік обов’язкових груп тривог*
...
У списках активних тривог (активних, банерах, журналах) фони написів повинні змінюватися за кольором відповідно до пріоритету. У табл. 16.9 показано способи відображення та з оповіщення відповідно до пріоритету для кожного з станів, окрім нормального (в журналах завжди білий фон). Заблоковані тривоги не показуються у списках активних тривог.  

Таблиця 16.9. Вимоги до візуальної індикації кольором у списках тривог та звукового оповіщення тривог за пріоритетами
...
Кольори та миготіння повинні відповідати кольорам з табл. 16.9. За можливості рекомендується в написах символів вказувати символьні позначення класу тривоги. 
...
Користувачі з правами технолога мають мати можливість змінити уставки тривог: граничні значення, затримку часу на спрацювання. 

У табл. 16.10 подано початкові налаштування технологічних тривог для аналогових (числових) змінних. Межі LOLO, LO, HO, HIHI вказують на межі відповідно аварійно низького, низького, високого та аварійно високого значення змінної. Усі зазначені тривоги мають спрацьовувати за замовченням через 2 с після переходу через межу. Значення "Deviation" (відхилення) вказує на максимальну величину відхилення змінної від заданого значення. Затримка на спрацювання тривоги – 5 с.

Усі тривоги повинні зберігатися в журнал і відображатися в списку та зведенні тривог.  

Таблиця 16.10. Налаштування аналогових (числових) тривог за змінними 
...
У табл. 16.6 вказано перелік тривог за дискретними змінними. 

Таблиця 16.11. Фрагмент переліку дискретних (типу так/ні) тривог
...
## 16.8. Вимоги до ведення журналу подій

Слід передбачити ведення журналу подій, куди мають заноситися:

- технологічні події, перелічені в табл. 16.12;
...
Таблиця 16.12. Перелік подій та відповідних повідомлень у журналі
...
## 16.9. Вимоги до архівування та виведення трендів
...
Усі тренди повинні зберігатися протягом 60 днів. На початку кожного місяця тренди повинні експортуватися в окремо виділене для цього місце на жорсткому диску. Перелік аналогових змінних для записування в тренд наведений у табл. 16.13. За неможливості в системі налаштувати умови записування за зміни, значення повинні зберігатися з указаною періодичністю опитування.   

Таблиця 16.13. Перелік аналогових (числових) змінних для архівування
...
Перелік дискретних змінних для записування в тренд наведений у табл. 16.14. Запис дискретних змінних у тренд повинен відбуватися за зміни значення або стану (якості), або з дискретністю, визначеною в періодичності опитування. 

Таблиця 16.14. Перелік дискретних (типу так/ні) змінних для архівування
...
## 16.10. Вимоги до інших груп функцій 
...
**Вимоги до керування рецептами.** У вимогах треба вказати, чи потребується в рецептах зміна процедури, яка, можливо, затребує додаткового модуля керування рецептами відповідно до стандартів ISA-88/IEC-61512. Якщо ж керування рецептами передбачає використання класичного функціоналу, у вимогах можуть бути вказані:
...
**Вимоги до календарного планування (керування за розкладом).** У переліку вимог можуть бути вказані:
...
**Вимоги до мультимовної підтримки.** Вони можуть бути частиною вимог до лінгвістичного забезпечення. У вимогах можуть бути наведені:
...
**Вимоги до обміну з іншими системами SCADA/HMI та інтегрування з верхнім рівнем.** Рішення щодо технічної та інформаційної структури системи приймаються на проектних етапах розроблення інтегрованої системи керування (ескізний або технічний проект). На етапі формування завдання для SCADA/HMI, який, по суті, може стартувати вже на стадії робочої документації або введення в дію системи керування, рішення щодо структури вже має бути прийняте. Тому вимоги можуть зводитися до зазначення способу інтеграції та відомості змінних, які беруть участь в обміні.  

## 16.11. Реалізація ПЗ SCADA/HMI
...
Наведений порядок розроблення є прикладом, а не правилом. Слід також передбачати можливість паралельного розроблення проекту для SCADA/HMI та для ПЛК. 

## 16.12. Експлуатаційна документація 
